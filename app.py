...
# --- 2. 網頁基礎配置 ---
st.set_page_config(page_title="西語全能家教 4.4", page_icon="🇪🇸", layout="wide")
...
with tab1:
    ...
    if st.session_state['study_material']:
        ...
        try:
            ...
            notes_part = sub_parts[1].strip() if len(sub_parts) > 1 else "請重新生成"
